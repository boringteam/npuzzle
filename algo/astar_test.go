...
func TestTabInSlice(t *testing.T) {
	...
	open_node1 := createNode(nil, []int16{8, 2, 5, 1, 6, 3, 0, 4, 7}, result)
	open_node2 := createNode(nil, []int16{2, 8, 5, 1, 6, 3, 0, 4, 7}, result)
	open_node3 := createNode(nil, []int16{5, 2, 8, 1, 6, 3, 0, 4, 7}, result)

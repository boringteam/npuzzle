...
func TestTabInSlice(t *testing.T) {
  open_node1 := node{parent: nil, F:0, G:0, H:0, tab: []int{8, 2, 5, 1, 6, 3, 0, 4, 7}}
  open_node2 := node{parent: nil, F:0, G:0, H:0, tab: []int{2, 8, 5, 1, 6, 3, 0, 4, 7}}
  open_node3 := node{parent: nil, F:0, G:0, H:0, tab: []int{5, 2, 8, 1, 6, 3, 0, 4, 7}}
